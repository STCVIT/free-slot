...
const Forgot = () => {
  ...
  return (
    <>
        <section className='bg-myBlue h-screen flex'>
            <div className='max-w-lg m-auto bg-white px-12 py-12 rounded-md'>
            <h4 className='text-md font-normal text-center'>Enter your email to receive a link to reset your password</h4>
                ...
                <button className='bg-myBlue py-3 px-4 w-full text-white rounded-md mt-1.5' type='submit'>Submit</button>
                </form>
            </div>
        </section>
    </>
