            ...
            <img src={signupInfoImg} alt="signup" class="signup-image"/>
                ...
                <form class='bg-whiteshadow-md rounded px-8 pt-6 pb-8 mb-4'>
                    ...
                    <div class="mb-6">
                        ...
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="password" type="password" placeholder="Enter 6-digit password" />
                    </div>
